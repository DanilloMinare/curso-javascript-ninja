...
*/
function calculator(paramX, paramY){
    return function (callback) {
        return callback(paramX, paramY)
    }
}
...
console.log( sum(function (var1,var2){ return var1+var2} ) )
